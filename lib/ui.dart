      ...
      if (response.body.trim().startsWith('<')) {
        ...
        try {
          ...
          setState(() {
            ...
            _statusMessage = "START ACTIVITY: ${response.statusCode} - ${responseData.toString()}";
          });
        } catch (jsonError) {
          setState(() {
            _isStartLoading = false;
            ...
            _statusMessage = "START ACTIVITY: ${response.statusCode} - ${response.body}";
          });
        }
      }
      ...
      if (response.body.trim().startsWith('<')) {
        ...
        try {
          ...
          setState(() {
            ...
            _statusMessage = "END ACTIVITY: ${response.statusCode} - ${responseData.toString()}";
          });
        } catch (jsonError) {
          setState(() {
            _isStartLoading = false;
            ...
            _statusMessage = "END ACTIVITY: ${response.statusCode} - ${response.body}";
          });
        }
      }
